export const dialogues = {
    ...
    "d1phase4g": [
        ...
        "n Cette position fait augmenter la jauge.",
        "relax n Maintiens Shift lors du combat pour utiliser la position de détente.",
        "n Cette position fait diminuer la jauge.",
        "idle n Reste le plus longtemps possible dans la zone verte pour désamorcer le combat avec un dialogue.",
        ...
        "n Lorsque cela sera le cas, la jauge bondira en avant ou en arrière.", 
        "eidle n Attention : si Klint est en colère, il sera plus difficile d'apaiser les tensions.",
        "n Bonne chance !",
    ],
    "d1phase4b": [
