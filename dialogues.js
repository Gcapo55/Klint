export const dialogues = {
    ...
    "e Les gens de votre espèce ne savent donc pas lire ?",
],
"d3phase2g": [
...
"d3phase2b": [
    ...
    "e Et je vais vous faire une offre, à prendre ou à laisser.",
    "egivemoney e Prennez ces quelques dollars et allez voir ailleurs.",
],
"d3phase3g": [
    "k Je ne suis pas là pour l'argent.",
    "k Je suis à la poursuite d'un criminel.",
    "k Je dois passer, je vous en prie.",
    "e Hors de question !",
    "e Je ne peux me permettre de laisser passer un homme de votre condition sur ma propriété.",
],
"d3phase3b": [
    "bad k Gardez votre argent, monsieur Flint.",
    "k Le chemin est libre et j'ai le droit de passer.",
    "e Le droit ?! Le DROIT ?!",
    "e Les gens sans le sou parlent toujours de leurs droits...",
    "e C'est tout ce qu'ils ont, je suppose.",
...
"d3phase4b": [
    "bad k Vous êtes vraiment l'homme le plus agaçant que j'aie rencontré.",
    "e Agaçant ? AGAÇANT ?!",
...
"d3shot": [
    "k Voilà. On peut discuter quand on veut.",
    "k Retenez ça, monsieur Flint : le respect, ça coûte rien.",
    "k Bonne journée à vous.",
],
"d3badend": [
    ...
    "DFphase3g": [
        ...
        "angry e Raah, mais pour qui tu te prends ?",
        "e N'oublie pas Klint, toi et moi on est pas pareils.",
